<script lang="ts">
	...
	let toggleMap: { [x: string]: boolean } = {};
...
<div id="wrapper">
	<p>
		Careers at QBite Capital We have a spectrum of career opportunities for individuals with the
		right skills. This is our current job openings:
	</p>
	...
	<p>
		To submit resumes or ask questions, e-mail <a
			class="mail"
			href="mailto:recruitment@qbite.capital">recruitment@qbite.capital</a
		>.
	</p>
	<p>
	...
	<p>
		...
		discrimination on the bases of race, color, religion, national origin, disability, gender,
		sexual orientation, age, or any other protected status.
	</p>
</div>
